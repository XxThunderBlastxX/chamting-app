...
**1.** Fork [this](https://github.com/XxThunderBlastxX/chamting-app) repository.

**2.** Clone the forked repository.

```bash
git clone https://github.com/XxThunderBlastxX/chamting-app.git
```
...
**8.** Create a [PR](https://github.com/XxThunderBlastxX/chamting-app) .

### 🔑Guidelines

Here are some set of guidelines to follow while contributing to `chamting-app` :
